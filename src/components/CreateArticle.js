                ...
                <section id="content">
                    ...
                    <form className="mid-form" onSubmit={this.saveArticle}>
                        ...
                        <div className="form-group">
                            ...
                            <textarea name="content" ref={this.contenidoRef} onChange={this.changeState}></textarea>
                            {this.validator.message('content', this.state.article.content, 'required|string')}
